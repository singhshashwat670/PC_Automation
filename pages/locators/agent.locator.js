const agentLocators = {
  ...
  filterButton: (page) =>  page.getByRole('link', { name: 'Filter' }).first(),
  allocationSelectedText: (page) => page.locator('#select2-ddlAllocation-container'),
  allocationDropdown: (page) => page.locator('#select2-ddlAllocation-container'),
  ...
  closePopupButton: (page) => page.getByRole('button', { name: /^Close$/i }).first(),
